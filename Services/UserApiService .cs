...
*/
    ...
    public override Task<ListDriverLicence> GetListDriverLicences(Empty request, ServerCallContext context)
    {
        return base.GetListDriverLicences(request, context);
    }

    public override Task<DriverLicenceObject> CreateDriverLicence(CreateOrUpdateDriverLicenceRequest request, ServerCallContext context)
    {
        return base.CreateDriverLicence(request, context);
    }

    public override Task<DriverLicenceObject> UpdateDriverLicence(CreateOrUpdateDriverLicenceRequest request, ServerCallContext context)
    {
        return base.UpdateDriverLicence(request, context);
    }

    public override Task<DriverLicenceObject> DeleteDriverLicence(GetOrDeleteDriverLicenceRequest request, ServerCallContext context)
    {
        return base.DeleteDriverLicence(request, context);
    }
